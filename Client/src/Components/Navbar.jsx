  ...
  return (
    <>
      <div
       ...
       bg-white/80 border-b border-orange-100"
      >
        <div
        ...
        >
          ...
          {user && (
            <div className="hidden md:flex items-center gap-3">
              ...
              >
                <div
                  className="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500
                to-emerald-500 flex items-center justify-center flex-shrink-0"
                >
          ...
          <div className="md:hidden px-4 pb-4">
            ...
            >
              ...
              <div className="flex flex-col gap-3 mt-4">
                <button
                  className="w-full py-2.5 rounded-xl bg-gradient-to-r from-purple-500 to-emerald-500
                ...
                <button
                  className="w-full py-2.5 rounded-xl border border-orange-100
                bg-white text-gray-700 text-sm font-medium"
                  onClick={() => {
                    navigate("/billing");
                    setMenuOpen(false);
              ...
              <button
                ...
                className="mt-4 w-full flex items-center justify-center gap-2
                  py-2.5 rounded-xl bg-red-50 text-red-500 hover:bg-red-200
