      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center justify-between h-full px-5 py-6 sm:px-7 sm:py-8">
          <div className="relative mt-1">
            ...
            <div
              className={`relative w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full
                 bg-gradient-to-br ${current.orb} shadow-[0_0_120px_rgba(255,255,255,0.15)]
          ...
          <div className="text-center">
            ...
            <p
              className={`mt-4 text-[13px] sm:text-[15px] md:text-[16px] leading-6
                sm:leading-7 max-w-[280px] mx-auto ${current.sub}`}
            >
              Your smart voice assistant.
              <br />
              Ask anythinng about your website.
            </p>
