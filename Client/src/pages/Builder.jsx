          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
              ...
              >
                ...
                <h2
                  className="text-xl font-bold text-[#081028]
                mt-1 capitalize"
                >
                  {user?.plan}
                </h2>
            ...
            <div className="mt-7">
              <div
                className="mt-4 rounded-2xl bg-amber-50
              ...
              >
                ...
                <pre
                  className="mt-3 bg-[#0b1020] text-emerald-400
                rounded-xl p-3 text-xs font-mono overflow-x-auto"
                >
                  {`<body>
              ...
              <p
                className="text-sm font-medium text-[#081028]
              mb-3 mt-3"
              >
                Embed Code
              </p>
            ...
            <div className="relative">
              <textarea
                readOnly
                value={embedCode}
                className="w-full h-20 bg-[#0b1020]
              text-emerald-400 rounded-2xl p-4 text-sm
            ...
            <button
              ...
              className="mt-6 h-12 px-6 rounded-2xl bg-gradient-to-r
             from-purple-500 to-emerald-500 text-white font-medium"
            >
              Edit Assistant
            </button>
          </div>
            ...
            >
              ...
              rounded-2xl px-4 py-3"
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200
              rounded-2xl px-4 py-3 resize-none"
                />
              </div>
            </div>
           ...
           border-gray-100 shadow-sm p-6"
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Add your Gemni API key to power your assistant
                  </p>
                </div>
                <a
                  ...
                  className="px-4 py-2 rounded-xl bg-gradient-to-r from-purple-500
                 to-emerald-500 text-white text-sm 
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-5 flex-wrap">
               ...
               from-purple-500 to-emerald-500 text-white text-sm"
                >
                  <FiPlus /> Add
                </button>
              </div>
            ...
            <button
              ...
              className="w-full h-14 rounded-2xl bg-gradient-to-r from-purple-500 to-emerald-500 text-white
