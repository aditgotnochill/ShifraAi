    ...
    <>
      <div className="min-h-screen bg-[#f8fafc] overflow-hidden">
        <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20">
          ...
          <div className="relative max-w-6xl mx-auto">
            ...
            <div className="text-center mt-10 sm:mt-12">
              <h1
                className="max-w-5xl mx-auto text-[42px] leading-[52px] sm:text-6xl
               sm:leading-[72px] lg:text-7xl lg:leading-[88px] font-black tracking-[-0.04em] text-[#081028]"
              >
                Add a{""}
              ...
              <p
                className="max-w-2xl mx-auto mt-7 text-sm sm:text-lg lg:text-xl text-[#64748b]
              ...
              >
                <button
                  ...
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-gradient-to-r from-purple-500 to-emerald-500
                 text-white font-semibold text-sm sm:text-base shadow-[0_12px_40px_rgba(168,85,247,0.25)] 
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-20 bg-white">
          <div className=" max-w-6xl mx-auto">
            <div className="text-center mb-14">
              ...
              <p className="text-gray-500 mt-3 tex-sm sm:text-base">
            ...
            >
              {STEPS.map((s, i) => (
                <div
                  key={i}
                  className="group bg-[#f8fafc] hover:bg-white border border-gray-100
                rounded-[28px] p-7 transition-all hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)]"
                >
        ...
        <footer className="bg-gray-200 px-6 py-10">
          <div
            className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between
